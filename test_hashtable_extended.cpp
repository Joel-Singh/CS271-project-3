...
void test_get_key_extended() {
  try {
    ...
    if (elemInt.get_key() != -1) {
      cout << "Expected key = -1 but got: " << elemInt.get_key()
           << " Try again!" << endl;
    }
    if (elemBool.get_key() != -1) {
      cout << "Expected key = -1 but got: " << elemBool.get_key() << " Oh no!"
           << endl;
    }
    if (elemChar.get_key() != -1) {
      cout << "Expected key = -1 but got: " << elemChar.get_key() << " Too bad!"
           << endl;
    }
    if (elemString.get_key() != -1) {
      cout << "Expected key = -1 but got: " << elemString.get_key()
           << " So sad!" << endl;
    }
    ...
    if (elemInt1.get_key() != 5) {
      cout << "Expected key = 5 but got: " << elemInt1.get_key()
           << " Try again!" << endl;
    }
    if (elemBool1.get_key() != 19) {
      cout << "Expected key = 19 but got: " << elemBool1.get_key() << " Oh no!"
           << endl;
    }
    if (elemChar1.get_key() != 212) {
      cout << "Expected key = 212 but got: " << elemChar1.get_key()
           << " Too bad!" << endl;
    }
    if (elemString1.get_key() != 732) {
      cout << "Expected key = 732 but got: " << elemString1.get_key()
           << " So sad!" << endl;
    }
...
void test_get_data_extended() {
  try {
    ...
    if (elemInt.get_data() != 0) {
      cout << "Expected data = 0 but got: " << elemInt.get_key()
           << " Try again!" << endl;
    }
    if (elemBool.get_data() != 0) {
      cout << "Expected data = 0/False but got: " << elemBool.get_key()
           << " Oh no!" << endl;
    }
    if (elemChar.get_data() != '\0') {
      cout << "Expected data = empty char but got: " << elemChar.get_key()
           << " Too bad!" << endl;
    }
    if (elemString.get_data() != "") {
      cout << "Expected data = empty string but got: " << elemString.get_key()
           << " So sad!" << endl;
    }
    ...
    if (elemInt1.get_data() != 86) {
      cout << "Expected data = 86 but got: " << elemInt1.get_data()
           << " Try again!" << endl;
    }
    if (elemBool1.get_data() != 0) {
      cout << "Expected data = 0 but got: " << elemBool1.get_data() << " Oh no!"
           << endl;
    }
    if (elemChar1.get_data() != 'a') {
      cout << "Expected data = a but got: " << elemChar1.get_data()
           << " Too bad!" << endl;
    }
    if (elemString1.get_data() != "dataByte") {
      cout << "Expected data = dataByte but got: " << elemString1.get_data()
           << " So sad!" << endl;
    }
...
void test_member_extended() {
  ...
  if (htString.member("Fly like a bird", 91) != false) {
    cout << "Expected: 0 but got: " << htString.member("Fly like a bird", 91)
         << endl;
  }
